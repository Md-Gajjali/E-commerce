        ...
        <Flex className='gap-2.5 items-center justify-between'>
          ...
          <div className='w-200 shadow py-9 px-8.5   mt-22' >
            <Flex className='justify-between'>
              <input type="text" placeholder='Your Name ' className='px-3 py-4 rounded-sm bg-gray-100 outline-none focus:outline-none ' />
              <input type="text" placeholder='Your Name ' className='px-3 py-4 rounded-sm bg-gray-100 outline-none focus:outline-none' />
              <input type="text" placeholder='Your Name ' className='px-3 py-4 rounded-sm bg-gray-100 outline-none focus:outline-none ' />
            </Flex>
            <input type="text" placeholder='Your Name ' className='w-full  h-52.5 mt-10  px-3 rounded-sm bg-gray-100 outline-none focus:outline-none text-start' />
