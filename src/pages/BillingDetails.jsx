                ...
                <Flex className='mt-20 justify-between '>
                    <div>
                        <div>
                            ...
                            <input type="text" placeholder='inter your name' className='w-117.5 h-12.5 px-4 py-3 rounded-sm  outline-none focus:outline-none mt-2 bg-gray-100' />
                        </div>
                        <div className='mt-7.5'>
                            <label htmlFor="" className='block font-pop  text-[16px]'>Company Name</label>
                            <input type="text" placeholder='Company Name' className='w-117.5 h-12.5 px-4 py-3 rounded-sm  outline-none focus:outline-none mt-2 bg-gray-100' />
                        </div>
                        <div className='mt-7.5'>
                            <label htmlFor="" className='block font-pop  text-[16px]'>Street Address*</label>
                            <input type="text" placeholder='Street Address*' className='w-117.5 h-12.5 px-4 py-3 rounded-sm  outline-none focus:outline-none mt-2 bg-gray-100' />
                        </div>
                        <div className='mt-7.5'>
                            <label htmlFor="" className='block font-pop  text-[16px]'>Apartment, floor, etc. (optional)</label>
                            <input type="text" placeholder='Apartment, floor, etc. (optional)' className='w-117.5 h-12.5 px-4 py-3 rounded-sm  outline-none focus:outline-none mt-2 bg-gray-100' />
                        </div>
                        <div className='mt-7.5'>
                            <label htmlFor="" className='block font-pop  text-[16px]'>Town/City*</label>
                            <input type="text" placeholder='Town/City*' className='w-117.5 h-12.5 px-4 py-3 rounded-sm  outline-none focus:outline-none mt-2 bg-gray-100' />
                        </div>
                        <div className='mt-7.5'>
                            <label htmlFor="" className='block font-pop  text-[16px]'>Phone Number*</label>
                            <input type="text" placeholder='Phone Number*' className='w-117.5 h-12.5 px-4 py-3 rounded-sm  outline-none focus:outline-none mt-2 bg-gray-100' />
                        </div>
                        <div className='mt-7.5'>
                            <label htmlFor="" className='block font-pop  text-[16px]'>Email Address*</label>
                            <input type="text" placeholder='Email Address*' className='w-117.5 h-12.5 px-4 py-3 rounded-sm  outline-none focus:outline-none mt-2 bg-gray-100' />
                        </div>
